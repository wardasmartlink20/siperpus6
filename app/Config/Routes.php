...
$routes->group("", ['filter' => 'cors'], function ($routes) {
  ...
  $routes->get('/api/books/(:num)', 'BookController::detailBookApi/$1');
  $routes->get('/api/category', 'CategoryController::categoryApi');
  ...
  $routes->get('/api/reviews', 'ReviewController::listReviewApi'); 
